...
export const SKILLS_CLI_AGENT_KEY_BY_TUI_AGENT = {
  ...
  trae: 'trae-cn',
  muse: null,
  // Why: upstream maps this to 'zcode', but the installed community skills CLI (v1.4.6)
  // has no `zcode` key in its own namespace — `skills add --agent zcode` would exit 1.
  zcode: null
