...
function readUsageData<T extends UsageShape<string, string, UsageSnapshot>>(
  ...
  // SAFETY: slice fields live under derived `${prefix}Usage${Field}` keys that are not part of
  // AppState's static type; the keyed slice factory guarantees they exist at runtime.
