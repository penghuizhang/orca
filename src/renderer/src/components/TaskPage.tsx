...
import { formatUiRelativeTimeFromDate } from '../../../shared/i18n/relative-time-format'
import { GiteeTasksBoard } from '@/components/GiteeTasksBoard'
...
export default function TaskPage(): React.JSX.Element {
  ...
  return (
    <TaskPageLayout
      ...
      giteeView={
        taskSource === 'gitee' ? <GiteeTasksBoard formatRelativeTime={formatRelativeTime} /> : null
      }
